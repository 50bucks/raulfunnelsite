    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <Script id="gtm" strategy="afterInteractive">
          ...
          })(window,document,'script','dataLayer','GTM-MGK5424H');`}
        </Script>
      ...
      <body className="font-body antialiased" suppressHydrationWarning>
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MGK5424H"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1096838792537295&ev=PageView&noscript=1"
          />
        </noscript>
        {children}
        <Toaster />
